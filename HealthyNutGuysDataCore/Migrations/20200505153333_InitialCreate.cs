        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deleted = table.Column<bool>(nullable: true),
                    IsOnSale = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    IsOnSale = table.Column<bool>(nullable: true),
                    SaleItemId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomSacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomSacks_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomSacks_SaleItems_SaleItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomSelectOptions_CustomSacks_CustomSackId",
                        column: x => x.CustomSackId,
                        principalTable: "CustomSacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MixCategories_CustomSacks_CustomSackId",
                        column: x => x.CustomSackId,
                        principalTable: "CustomSacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tags_CustomSacks_CustomSackId",
                        column: x => x.CustomSackId,
                        principalTable: "CustomSacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpecialOffers_CustomSacks_CustomSackId",
                        column: x => x.CustomSackId,
                        principalTable: "CustomSacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomSacks_CategoryId",
                table: "CustomSacks",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomSacks_SaleItemId",
                table: "CustomSacks",
                column: "SaleItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomSelectOptions_CustomSackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MixCategories_CustomSackId",
                table: "MixCategories",
                column: "CustomSackId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialOffers_CustomSackId",
                table: "SpecialOffers",
                column: "CustomSackId");
