...
using HealthyNutGuysAPI.Utilities;
...
namespace HealthyNutGuysAPI.Controllers
{
    ...
    public class TokenController : HealthyNutGuysBaseController
    {
        ...
        public TokenController(IHealthyNutGuysSupervisor moviesPlaceSupervisor,
          Token token,
