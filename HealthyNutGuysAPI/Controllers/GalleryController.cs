...
namespace HealthyNutGuysAPI.Controllers
{
    ...
    public class GalleryController : HealthyNutGuysBaseController
    {
        ...
        #region Constructor
        public GalleryController(IHealthyNutGuysSupervisor supervisor, CloudinaryService cloudinaryService)
        {
