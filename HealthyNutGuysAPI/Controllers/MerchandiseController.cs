...
namespace HealthyNutGuysAPI.Controllers
{
    ...
    public class MerchandiseController : HealthyNutGuysBaseController
    {
        ...
        #region Constructor
        public MerchandiseController(IHealthyNutGuysSupervisor supervisor, UserManager<ApplicationUser> userManager, CloudinaryService cloudinaryService, ISendEmailService emailService)
        {
